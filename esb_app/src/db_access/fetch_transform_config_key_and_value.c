...
@brief : Under this modeule we will be accessing config_key and config_value
from transform table so that we can apply transformation steps

Command to run is : gcc fetch_transform_config_key_and_value.c -L/usr/local/mysql/lib -lmysqlclient -o out
*/
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
